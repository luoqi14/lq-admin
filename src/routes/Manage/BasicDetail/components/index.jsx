      ...
      <div style={{ width: '100%' }} className={className}>
        ...
        <DetailPage
          ...
          fields={[
            {
              type: 'title',
              label: '表单组件集合，功能包括：布局，可编辑及查看，校验，传入值（可做默认值），输出值。',
              className: 'warning',
            },
            {
              label: '嵌套1',
            ...
            },
            {
              ...
              name: 'html1',
              type: 'html',
              html: <a href="/1.pdf" target="_blank">pdf</a>,
            },
            {
              label: '开关',
              name: 'switch1',
            ...
            },
            {
              ...
              unit: <a download="111" href="/1.pdf"><Icon type="download" />下载</a>,
              onPreview: (value, i) => {
